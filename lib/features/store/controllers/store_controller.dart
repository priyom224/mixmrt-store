...
class StoreController extends GetxController implements GetxService {
  ...
  Future<void> addItem(Item item, bool isAdd, String moduleType) async {
    _isLoading = true;
    update();
    debugPrint('-------------->>>add${item.weight}');
    ...
    bool isSuccess = await storeServiceInterface.addItem(item, _rawLogo, _rawImages, _savedImages, fields, isAdd, tags, moduleType);
    if(isSuccess) {
