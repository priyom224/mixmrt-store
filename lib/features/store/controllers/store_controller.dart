...
class StoreController extends GetxController implements GetxService {
  ...
  Future<void> addItem(Item item, bool isAdd, String moduleType, {String? genericNameData}) async {
    _isLoading = true;
    update();
    ...
    Response response = await storeServiceInterface.addItem(item, _rawLogo, _rawImages, _savedImages, fields, isAdd, tags, moduleType, nutrition, allergicIngredients, genericName);
