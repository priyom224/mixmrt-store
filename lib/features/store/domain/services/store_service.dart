...
class StoreService implements StoreServiceInterface {
  ...
  @override
  Future<Response> addItem(Item item, XFile? image, List<XFile> images, List<String> savedImages, Map<String, String> attributes, bool isAdd, String tags, String moduleType, String nutrition, String allergicIngredients, String genericName) async {
    return await storeRepositoryInterface.addItem(item, image, images, savedImages, attributes, isAdd, tags, moduleType, nutrition, allergicIngredients, genericName);
  }
