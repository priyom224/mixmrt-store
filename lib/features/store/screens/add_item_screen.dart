                ...
                onPressed: () {
                  ...
                  if(defaultDataNull) {
                    ...
                    if(hasEmptyValue) {
                      ...
                      storeController.addItem(_item, widget.item == null, Get.find<ProfileController>().profileModel!.stores!.first.module!.moduleType!, genericNameData: _genericNameSuggestionController.text.trim());
                    }
                  }
                },
