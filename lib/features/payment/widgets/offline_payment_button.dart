...
class OfflinePaymentButton extends StatelessWidget {
  ...
  const OfflinePaymentButton({super.key, required this.isSelected, required this.offlineMethodList, required this.onTap, required this.tooltipController, required this.paymentController});
        ...
        child: Column(children: [
          ...
          isSelected ? GridView.builder(
            ...
            itemBuilder: (context, index) {
              bool isSelected = paymentController.selectedOfflineBankIndex == index ;
              return InkWell(
                onTap: () => paymentController.selectOfflineBank(index),
                child: Container(
                  decoration: BoxDecoration(
