...
class TaxiMenuScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    menuList.add(TaxiMenuModel(icon: Images.policy, title: 'privacy_policy'.tr, route: const HtmlViewerScreen(isPrivacyPolicy: true, isAgreement: false)));
    menuList.add(TaxiMenuModel(icon: Images.terms, title: 'terms_condition'.tr, route: const HtmlViewerScreen(isPrivacyPolicy: false, isAgreement: false)));
